...
public class CardMapper {
    ...
    public static List<CardEntity> toCardEntityList(List<CardDto> cardDtos) {
        List<CardEntity> dtoToEntityList = new ArrayList<>();
        for (CardDto cardDto : cardDtos) {
            CardEntity cardEntity = toCardEntity(cardDto);
            dtoToEntityList.add(cardEntity);
        }
        return dtoToEntityList;
